...
// Function that re-checks engine size radio button that user checked			
			var radios = document.forms[0].engineSize;
			for(var i = 0; i<radios.length; i++){
...
// Function that re-checks engine booster radio button that user checked			
			var radio_2 = document.forms[0].HighPo;
			for(var i = 0; i<radio_2.length; i++){
...
// Function call below for the dynamic select drop-down select for Vehicle Year below. //
	    //mkSelect();
	    //mksList();
